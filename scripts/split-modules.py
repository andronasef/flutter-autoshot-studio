...
CSS_SPLITS = [
    ...
    (
        ...
        576,
        878,
        "UI controls, buttons, text-style bar, gradient editor",
    ),
    ...
    (
        ...
        1206,
        1706,
        "All modal base styles (project, translate, settings, device)",
    ),
    (
        "css/ui.css",
        1707,
        2499,
        "Preset backgrounds, tabs, font picker, toggles, checkboxes, "
    ...
    (
        ...
        2622,
        3163,
        "Language picker, languages modal, flags, translations modal, "
    ...
    (
        ...
        3164,
        3590,
        "Elements tab, popouts tab, canvas drag cursor, emoji/icon pickers",
    ),
    (
        "css/autoshot.css",
        3591,
        3860,
        "Autoshot import modal, device category tabs, mapping rows",
    ),
]
